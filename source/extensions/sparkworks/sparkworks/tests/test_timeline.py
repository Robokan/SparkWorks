...
class TestTimeline(omni.kit.test.AsyncTestCase):
    ...
    async def test_empty_timeline(self):
        ...
        self.assertIsNone(self.timeline.current_solid)
    ...
    async def test_add_extrude(self):
        """Adding a sketch + extrude should produce a solid."""
        from sparkworks.kernel import Sketch
        ...
        # After extrude, there should be a solid
        self.assertIsNotNone(self.timeline.current_solid)
